...
# Load environment variables from .env in the backend directory (if present)
...
# Database
# Use PostgreSQL if POSTGRES_* environment variables are provided, otherwise fall back to SQLite for local dev
