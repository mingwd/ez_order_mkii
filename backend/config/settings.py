...
SECRET_KEY = 'django-insecure-your-secret-key-change-later'
...
# Database - Using SQLite for now (easy for development)
DATABASES = {
    'default': {
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'America/Los_Angeles'  # Seattle timezone
USE_I18N = True
USE_TZ = True
